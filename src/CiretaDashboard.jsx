  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex">
      ...
      <main className={`flex-1 ${sidebarCollapsed ? 'ml-16' : 'ml-64'} transition-all duration-300`}>
        ...
        <div className="bg-[#13636f] text-white text-[11px] sm:text-xs px-4 py-1.5 text-center font-medium tracking-wide">
          <span className="opacity-90">Portfolio demo · Built at BIG IMMERSIVE by Muhammad Bilal · Numbers shown are synthetic</span>
